...
<div class="good-grades">
    ...
    <div class="row row-good-grades">
        <div class="col-sm-6  svg-good-grades" >
                       ...
                       <g>
                            ...
                            <defs>
                                    <pattern id="img1" patternUnits="userSpaceOnUse" width="400" height="auto">
                                      <image xlink:href="/images/backgroundImages/home_first_screen_bg.jpg" x="0" y="0" width="400px" height="500px" />
                                    </pattern>
        ...
        <div class="col-sm-6" style=" text-align:left;">
                ...
                <div class="home_prof_essay_item" style="padding-right:20%; padding-top:100px;">
                        ...
                        <p style="font-family: Overpass; color:#4d4d4d; font-size:16pt;">Have you been struggling to complete all of your school or college homework?
                            Now is a good time to speak to studyref.com to find out how we can give you some academic assistance.
                            </p>
...
<div class="testimonials" >
            ...
            <div class="float-pane" style="height: 500px; width: 75%; background-color: white; position:absolute; top:500px; left:13%;">
                <div class="slideshow-container">
                    ...
                    <div class="mySlides fade">
                      ...
                      <div class="message"><p>I really have to thank you guys! You came in when I had literally just a day
                        to my deadline. Thanks a bunch!</p> </div>
                        <span class="close">&rdquo;</span>
                      <div class="text">-Alan, TX</div>
                    </div>
                    ...
                    <div class="mySlides fade">
                      ...
                      <span class="open">&ldquo;</span>
                      <div class="message"><p>The quality of work is commendable. The originality of the written work
                        is original and authentic, just as you prommised. Cheers!</p>  </div>
                        <span class="close">&rdquo;</span>
                      <div class="text">-Becky Alomide, NG</div>
                    </div>
                    ...
                    <div class="mySlides fade">
                      ...
                      <span class="open">&ldquo;</span>
                      <div class="message"><p>I love that I can get quality that I can rely on at an affordable rate. I understand that the site is under maintainance
                        so I forgive you for the minor glitches. I look forward for a longterm partnership! </p></div>
                        <span class="close">&rdquo;</span>
                      <div class="text">-Paul Applewhite, NY</div>
    ...
    <section class="succeed">
        <div class="row">
            <div class="col-sm-6" style="text-align:left; width:50%; padding-left:15%; padding-right:1px; margin:0;">
                    ...
                    <div class="row row-good-grades">
                        <div class="col-sm-6 svg-good-grades" >
                            <svg width='100%' height="700px" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect id="rect-clear" width="400" height="500px"  x='150' y="100" style="fill:transparent; stroke:#66a3ff; stroke-width:5px;">
                
                                </rect>

                                <rect id="rect-clear-md" width="400" height="500px"  x='100' y="100" style="fill:transparent; stroke:#66a3ff; stroke-width:5px; display:none;">
                
                                    </rect>
                
                                <rect id="rect-pic" width="400px" height="500px" x='200' y="70" style="fill=url(#img1); stroke:#66a3ff; stroke-width:5px;">
                
                                    </rect>

                                    <rect id="rect-pic-md" width="400px" height="500px" x='150' y="70" style="fill=url(#img1); stroke:#66a3ff; stroke-width:5px; display:none;">
    ...
    <section class="mwisho-mwisho">
        <div class="mwisho">
            <div class="row">
                <div class="col-sm-6">
                        <h3 style="margin-right: 0;">Benefit from homework online help</h3>
    ...
    <footer style="text-align:center;">
            <div class="footer_wrap" style="background-color:#0d0d0d !important;">
                <div class="footer_item">
                   <span style="color:white;">&copy; 2019 studyref.com - All rights reserved</span>
                </div>
                <div class="footer_item" style="color:white;">
                            <div class="to_blog">
                                Read our <a href="/">blog</a>
                            </div>
                        </div>
                <div class="footer_item">
